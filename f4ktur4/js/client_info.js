...
var list_of_form_fields = {
	...
	"client_tax_id": {
		"status": "",
		"message": "Prosím upravte tak, aby DIČ mělo alespoň 8 číslic.",
		"cleared_input_value": "",
		"to_clear": "yes",
...
var bank_message_both_nok = "Prosím upravte tak, aby č. ú. mělo alespoň 2 a max 10 číslic. Kód banky tak, aby měl 4 číslice.";
...
function to_enable_button() {
	...
	if ((list_of_form_fields.client_name.status == ok) &&
		(list_of_form_fields.client_address_town.status == ok) &&
		(list_of_form_fields.client_address_zip.status == ok)) {
